		...
		<div className="h-screen flex items-center justify-center">
			<div className="w-full h-full grid lg:grid-cols-2 p-4">
				<div className="max-w-xs m-auto w-full flex flex-col items-center">
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input type="email" placeholder="E-mail" className="w-full" {...field} />
										</FormControl>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input type="password" placeholder="Senha" className="w-full" {...field} />
										</FormControl>
										<FormMessage />
									</FormItem>
								)}
					...
					<Button
						className="w-full gap-3 border-2 hover:bg-background hover:text-text hover:shadow-md"
						variant={'outline'}
					>
						<GoogleLogo />
